...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MedBay — Patient Management" },
      {
        name: "description",
        content:
          "MedBay is a calm, patient-first hospital management system for registering patients, generating ID cards, and coordinating staff.",
      },
      { property: "og:title", content: "MedBay — Patient Management" },
      { property: "og:description", content: "A calm, patient-first hospital management system." },
